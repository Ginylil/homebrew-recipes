# fon (fifth-of-november) — Cursor plugin

This Cursor plugin provides rules and skills for **fon** — the terminal learning agent (code check, web UI, PTY interception, MCP). It is shipped from the same repo as the Homebrew tap so users can install fon with:
